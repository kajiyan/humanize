...
/***/ function(module, exports) {
	...
	(function (global) {
	  ...
	  Piano.prototype.setup = function () {
	    ...
	    var manifest = [{ id: 'O0_C', src: 'sounds/piano/O0-C.ogg' }, { id: 'O0_D', src: 'sounds/piano/O0-D.ogg' }, { id: 'O0_E', src: 'sounds/piano/O0-E.ogg' }, { id: 'O0_F', src: 'sounds/piano/O0-F.ogg' }, { id: 'O0_G', src: 'sounds/piano/O0-G.ogg' }, { id: 'O0_A', src: 'sounds/piano/O0-A.ogg' }, { id: 'O0_B', src: 'sounds/piano/O0-B.ogg' }, { id: 'O0_C#', src: 'sounds/piano/O0-C#.ogg' }, { id: 'O0_D#', src: 'sounds/piano/O0-D#.ogg' }, { id: 'O0_F#', src: 'sounds/piano/O0-F#.ogg' }, { id: 'O0_G#', src: 'sounds/piano/O0-G#.ogg' }, { id: 'O0_A#', src: 'sounds/piano/O0-A#.ogg' }];
	    ...
	    for (var octaveIndex = 0; octaveIndex < this.options.octaveNum; octaveIndex++) {
	      ...
	      for (var blackKeyIndex = 0; blackKeyIndex < BLACK_KEY_NUM; blackKeyIndex++) {
	        ...
	        // 黒鍵を描画する
	        blackKey.graphics.setStrokeStyle(1).beginStroke('#5a5a5a').beginFill('#ffffff').drawRect(blackKeyOffsetX + whiteKeyWidth * blackKeyIndex, 0, blackKeyWidth, whiteKeyHeight);
