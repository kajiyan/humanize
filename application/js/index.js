...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  var SETTING = (0, _setting2.default)(("DEBUG_LOCAL"));
	  var IS_RETINA_SUPPORT = false;
	  ...
	  document.addEventListener('DOMContentLoaded', function () {
	    ...
	    console.log(SETTING.SOCKET_URL);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  var PRODUCTION_HOST = '160.16.230.26';
	  var PRODUCTION_PORT = 80;
	  var PRODUCTION_SOCKET_HOST = '';
	  var PRODUCTION_SOCKET_PORT = 8000;
	  ...
	  var DEBUG_LOCAL_SOCKET_HOST = '192.168.21.148'; // localhost
	  var DEBUG_LOCAL_SOCKET_PORT = 3000;
	  ...
	  if (typeof window !== 'undefined' && window !== null) {
	    ...
	    result.PAGES = __webpack_require__(4).pages;
	...
	(function (global) {
	  ...
	  function _load() {
	    ...
	    return new Promise(function (resolve, reject) {
	      ...
	      // ローディングマニフェストを作る
	      for (var i = 0; i < _this.options.octaveNum; i++) {
	        var octave = _this.options.octaveOffset + i;
	
	        manifest = manifest.concat([{ id: 'O' + octave + '-C', src: 'sounds/piano/O' + octave + '-C.ogg' }, { id: 'O' + octave + '-C#', src: 'sounds/piano/O' + octave + '-CS.ogg' }, { id: 'O' + octave + '-D', src: 'sounds/piano/O' + octave + '-D.ogg' }, { id: 'O' + octave + '-D#', src: 'sounds/piano/O' + octave + '-DS.ogg' }, { id: 'O' + octave + '-E', src: 'sounds/piano/O' + octave + '-E.ogg' }, { id: 'O' + octave + '-F', src: 'sounds/piano/O' + octave + '-F.ogg' }, { id: 'O' + octave + '-F#', src: 'sounds/piano/O' + octave + '-FS.ogg' }, { id: 'O' + octave + '-G', src: 'sounds/piano/O' + octave + '-G.ogg' }, { id: 'O' + octave + '-G#', src: 'sounds/piano/O' + octave + '-GS.ogg' }, { id: 'O' + octave + '-A', src: 'sounds/piano/O' + octave + '-A.ogg' }, { id: 'O' + octave + '-A#', src: 'sounds/piano/O' + octave + '-AS.ogg' }, { id: 'O' + octave + '-B', src: 'sounds/piano/O' + octave + '-B.ogg' }]);
	      }
	      ...
	      loadQueue.addEventListener('progress', function (e) {
	        _this.trigger('progress', e);
	      });
	
	      loadQueue.addEventListener('complete', function (e) {
	        _this.trigger('complete', e);
	  ...
	  function _setup() {
	    ...
	    var BLACK_KEY_NUM = 5;
	    var BLACK_KEY_CODE = ['C#', 'D#', 'F#', 'G#', 'A#'];
	    var WHITE_KEY_NUM = 7;
	    var WHITE_KEY_CODE = ['C', 'D', 'E', 'F', 'G', 'A', 'B'];
	    ...
	    for (var octaveIndex = 0; octaveIndex < this.options.octaveNum; octaveIndex++) {
	      ...
	      for (var whiteKeyIndex = 0; whiteKeyIndex < WHITE_KEY_NUM; whiteKeyIndex++) {
	        ...
	        // 白鍵を描画する
	        whiteKey.graphics.setStrokeStyle(1).beginStroke('#5a5a5a').beginFill('#ffffff').drawRect(whiteKeyOffsetX + whiteKeyWidth * whiteKeyIndex, 0, whiteKeyWidth, whiteKeyHeight);
	
	        // イベントリスナーを登録する
	        whiteKey.addEventListener('click', function () {
	          var keyCode = 'O' + (_this2.options.octaveOffset + octaveIndex) + '-' + WHITE_KEY_CODE[whiteKeyIndex];
	
	          return function (e) {
	            createjs.Sound.createInstance(keyCode).play();
	
	            _this2.trigger('keyBoardPress', {
	              'keyCode': keyCode
	            });
	          };
	        }());
	      ...
	      for (var blackKeyIndex = 0; blackKeyIndex < BLACK_KEY_NUM; blackKeyIndex++) {
	        ...
	        // 黒鍵を描画する
	        blackKey.graphics.setStrokeStyle(1).beginStroke('#5a5a5a').beginFill('#000000').drawRect(blackKeyOffsetX + whiteKeyWidth * blackKeyIndex, 0, blackKeyWidth, blackKeyHeight);
	
	        // イベントリスナーを登録する
	        blackKey.addEventListener('click', function () {
	          var keyCode = 'O' + (_this2.options.octaveOffset + octaveIndex) + '-' + BLACK_KEY_CODE[blackKeyIndex];
	  ...
	  Piano.prototype.setup = function () {
	    ...
	    return new Promise(function (resolve, reject) {
	      _load.call(_this3).then(function () {
	        _setup.call(_this3);
	        resolve(_this3, { status: 1 });
	      }, function () {
	        reject(_this3, { status: 0 });
	      });
	    });
	  };
